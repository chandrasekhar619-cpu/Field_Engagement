export const contentItems = [
  ...
  },
  {
    ...
    description: 'Share a heartfelt Raksha Bandhan wish with your customer.',
    personas: [],
    languages: ['EN', 'HI', 'MR', 'TE', 'TA'],
    demoType: 'creative',
  ...
  },
  {
    ...
    emoji: '👤',
    category: 'Occasion',
    title: 'RM Introduction',
    description: 'Introduce yourself and share your contact details with a customer.',
    personas: [],
    languages: ['EN'],
